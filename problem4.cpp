/*
Name of Program: problem4.cpp
Author: Logan Whitt
KUID: 3152587

Description: takes in matricies and outputs the sum of their diagonals
Output: given matricies and the sum of their diagonal elements
...
int main(){
    ...
    cout << "Matrix 1 Diagonals:" << endl;
    cout << matricies[0].return_matrix_diagonals() << endl;
    cout << "Matrix 2 Diagonals:" << endl;
    cout << matricies[1].return_matrix_diagonals() << endl;

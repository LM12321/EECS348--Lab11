...
Description: takes in matricies and adds them together using
overloading
Output: given matricies and the addition between them
...
class Matrix{
    ...
    public:
        ...
        Matrix transpose_matrix(){
            ...
            for (int i = 0; i < size_of_matrix; i++){   //iterate through rows
                vector<int> column;
                for (int j = 0; i < size_of_matrix; j++){   //iterate through columns
...
int main(){
    ...
    cout << "Matrix 1:" << endl;
    matricies[0].print_matrix();
    cout << "Matrix 2:" << endl;
    matricies[1].print_matrix();
    cout << "Result of Addition:" << endl;
    Matrix addition = matricies[0] + matricies[1];
